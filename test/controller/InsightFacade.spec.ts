...
describe("kevincgc c0 tests", function() {
	...
	describe("Ordered Queries", function () {
		let insightFacade: InsightFacade;
		before(async function () {
			clearDisk();
			insightFacade = new InsightFacade();
	...
	describe("C2 Add dataset exceptions", function () {
		...
		it("should DS pass, c2_4rooms_basic_biol_only", async function () {
		...
		it("should DS pass, c2_4rooms_no_views-row-first", async function () {
		...
		it("should DS pass, c2_4rooms_ignore_unlinked_rooms", async function () {
	...
	describe("List Datasets", function () {
		...
		it("C2 should RDS pass remove 1 of 3", async function () {
			await facade.addDataset("rooms0", rooms, InsightDatasetKind.Courses);
			await facade.addDataset("rooms1", rooms, InsightDatasetKind.Courses);
			await facade.addDataset("rooms2", rooms, InsightDatasetKind.Courses);
